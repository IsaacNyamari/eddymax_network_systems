        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                <form action="{{ route('store.search.index') }}" method="GET" class="relative"
                    ...
                    <div class="relative">
                        <input type="text" name="q" id="navbar-search-input" x-model="navSearchQuery"
                            @input.debounce.300ms="navPerformSearch($event.target.value)"
                            @focus="navSearchSuggestionsOpen = true"
                            @blur="setTimeout(() => navSearchSuggestionsOpen = false, 200)"
                            ...
                            placeholder="Search routers, CCTV, laptops, software, accessories..."
                    ...
                    <div x-show="navSearchSuggestionsOpen && navSearchQuery.length >= 2" x-cloak
                        ...
                        @click.away="navSearchSuggestionsOpen = false">
                        <div class="py-2">
                            {{-- Loading State --}}
                            <div x-show="navSearchLoading" class="px-4 py-3">
                                <div class="flex items-center space-x-3">
                            ...
                            {{-- Results Container --}}
                            <div x-show="!navSearchLoading">
                                <template x-if="navSearchResults.length === 0 && navSearchQuery.length >= 2">
                                    <div class="px-4 py-6 text-gray-500 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-700 font-medium">No products found for "<span
                                                    x-text="navSearchQuery" class="font-semibold"></span>"</p>
                                            <p class="text-sm text-gray-500 mt-1">Try different keywords or browse
                                                categories</p>
                                        </div>
                                    </div>
                                </template>
                                ...
                                <template x-if="navSearchResults.length > 0">
                                    <div>
                                        <div class="max-h-96 overflow-y-auto">
                                            <div class="px-4 py-3 bg-gray-50 border-b border-gray-200">
                                                <p class="text-sm font-semibold text-gray-700">
                                                    <span x-text="navSearchResults.length"></span> results found
                                                </p>
                                            </div>
                                            <template x-for="product in navSearchResults" :key="product.id">
                                                <a :href="product.url"
                                        ...
                                        <a :href="'/search?q=' + encodeURIComponent(navSearchQuery)"
                                            ...
                                            View all <span x-text="navSearchResults.length" class="font-bold"></span>
                                            results
