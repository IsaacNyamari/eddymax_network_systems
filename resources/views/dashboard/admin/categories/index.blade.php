                ...
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-900">
                            {{ \App\Models\Category::whereNull('parent_id')->count() }}</h3>
                    </div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            @if ($category->image)
                                               <img class="w-16" src="{{ asset('storage/' . $category->image) }}"
                                        alt="{{ $category->name }}">
                                            @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="inline-flex items-center">
                                        <span class="relative flex h-3 w-3 mr-2">
                                            <span
                                                class="animate-ping absolute inline-flex h-full w-full rounded-full {{ $category->is_active ? 'bg-green-400' : 'bg-gray-400' }} opacity-75"></span>
                                            <span
                                                class="relative inline-flex rounded-full h-3 w-3 {{ !$category->is_active ? 'bg-green-500' : 'bg-gray-500' }}"></span>
                                        </span>
                                        <span
                                            class="text-sm {{ $category->is_active ? 'text-green-700' : 'text-gray-700' }}">
