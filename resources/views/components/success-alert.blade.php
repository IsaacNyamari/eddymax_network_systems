<div x-data="{ alertInfo: false }" id="alertSuccess"
    class="bg-green-500 hidden text-white px-4 py-2 z-50 fixed top-10 mb-2 right-10 rounded-xl alert">
  ...
  c0-18.617,15.147-33.766,33.766-33.766c18.619,0,33.766,15.148,33.766,33.766C242.256,122.755,227.107,137.901,208.49,137.901z" />
        ...
        <span id="messageSuccess">That was successful!</span>
